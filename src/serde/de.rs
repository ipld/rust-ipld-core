...
use crate::{ipld::Ipld, serde::error::Error};
...
fn visit_map<'de, V>(map: BTreeMap<String, Ipld>, visitor: V) -> Result<V::Value, Error>
where
    V: de::Visitor<'de>,
{
...
fn visit_seq<'de, V>(list: Vec<Ipld>, visitor: V) -> Result<V::Value, Error>
where
    V: de::Visitor<'de>,
{
...
fn error<S, T>(message: S) -> Result<T, Error>
where
